                        ...
                        <hr size="10px" width="100%">
                            <p style="text-align:left;" class="ml-70 lightSpeedIn">
                                ...
                                <?php foreach($rows as $user){ ?>
                                    &emsp;帳號:&ensp;<input type="text" name="account" size="18" class="text lightSpeedIn" style="animation-duration:1.7s" placeholder="name" required readonly disabled value="<?=$user->account?>"/><br /><br />
                                    &emsp;暱稱:&ensp;<input type="text" name="name" size="18" class="text lightSpeedIn" style="animation-duration:1.7s" placeholder="name" required value="<?=$user->name?>"/><br /><br/>
                                    &emsp;性別:&ensp;<?php
                                    if($user->gender=="男"){
                                    ?>
